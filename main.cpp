...
int main()
{
    // auto result = loadAsioDriver("Focusrite USB ASIO");
    ...
    if(loadAsioDriver("Focusrite USB ASIO"))
    {
        ...
        std::cout << "ASIOGetChannels (inputs: " << mDriverInfo.inputChannels << ", outputs: " << mDriverInfo.outputChannels << ")" << std::endl;

        result = ASIOGetBufferSize(&mDriverInfo.minSize, &mDriverInfo.maxSize, &mDriverInfo.preferredSize, &mDriverInfo.granularity);
        if(result != ASE_OK)
        {
            ASIOExit();
            asioDrivers->removeCurrentDriver();
        ...
        std::cout << "ASIOGetBufferSize (min: " << mDriverInfo.minSize << ", max: " << mDriverInfo.maxSize << ", preferred: " << mDriverInfo.preferredSize << ", granularity: " << mDriverInfo.granularity << ")" << std::endl; 
        ...
        result = ASIOCreateBuffers(mDriverInfo.bufferInfos, mDriverInfo.inputBuffers + mDriverInfo.outputBuffers, mDriverInfo.preferredSize, &asioCallbacks);
        if(result != ASE_OK)
        {
            ASIOExit();
            asioDrivers->removeCurrentDriver();
        ...
        if(result == ASE_OK)
        {
            ...
            std::cout << "ASIOGetLatencies (input: " << mDriverInfo.inputLatency << ", output: " << mDriverInfo.outputLatency << ")" << std::endl;
        }
