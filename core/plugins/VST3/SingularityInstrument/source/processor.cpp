...
//------------------------------------------------------------------------
// SingularityInstrumentProcessor
//------------------------------------------------------------------------
SingularityInstrumentProcessor::SingularityInstrumentProcessor ()
{
	//--- set the wanted controller for our processor
	setControllerClass (kSingularityInstrumentControllerUID);
}
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::initialize (FUnknown* context)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::terminate ()
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::setActive (TBool state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::process (Vst::ProcessData& data)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::setupProcessing (Vst::ProcessSetup& newSetup)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::canProcessSampleSize (int32 symbolicSampleSize)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::setState (IBStream* state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityInstrumentProcessor::getState (IBStream* state)
{
