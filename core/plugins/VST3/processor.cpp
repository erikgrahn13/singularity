...
{
//------------------------------------------------------------------------
// SingularityEffectProcessor
//------------------------------------------------------------------------
SingularityEffectProcessor::SingularityEffectProcessor()
{
    //--- set the wanted controller for our processor
    setControllerClass(kSingularityEffectControllerUID);
    audioProcessor = createProcessorInstance();
}
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::initialize(FUnknown *context)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::terminate()
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::setActive(TBool state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::process(Vst::ProcessData &data)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::setupProcessing(Vst::ProcessSetup &newSetup)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::canProcessSampleSize(int32 symbolicSampleSize)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::setState(IBStream *state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API SingularityEffectProcessor::getState(IBStream *state)
{
