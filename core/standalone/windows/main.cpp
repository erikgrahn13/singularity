...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPTSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowEx(WS_EX_OVERLAPPEDWINDOW, szWindowClass, PLUGIN_NAME, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT,
    ...
    // SingularityAudio audio;
    // auto devices = audio.probeDevices();
    ...
    auto deviceList = audioManager->getDeviceList();
